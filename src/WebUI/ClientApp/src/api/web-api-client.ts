...
export class Category extends AuditableEntity implements ICategory {
    ...
    categoryTransactions?: CategoryTransaction[] | undefined;

    constructor(data?: ICategory) {
        super(data);
        if (data) {
            this.fund = data.fund && !(<any>data.fund).toJSON ? new Fund(data.fund) : <Fund>this.fund; 
            if (data.categoryTransactions) {
                this.categoryTransactions = [];
                for (let i = 0; i < data.categoryTransactions.length; i++) {
                    let item = data.categoryTransactions[i];
                    this.categoryTransactions[i] = item && !(<any>item).toJSON ? new CategoryTransaction(item) : <CategoryTransaction>item;
                }
            }
        }
    }
    ...
    init(_data?: any) {
        ...
        if (_data) {
            ...
            this.fund = _data["fund"] ? Fund.fromJS(_data["fund"]) : <any>undefined;
            if (Array.isArray(_data["transactions"])) {
                this.transactions = [] as any;
                for (let item of _data["transactions"])
                    this.transactions!.push(Transaction.fromJS(item));
            }
            if (Array.isArray(_data["categoryTransactions"])) {
                this.categoryTransactions = [] as any;
                for (let item of _data["categoryTransactions"])
                    this.categoryTransactions!.push(CategoryTransaction.fromJS(item));
            }
        }
    }
    ...
    toJSON(data?: any) {
        ...
        if (Array.isArray(this.categoryTransactions)) {
            data["categoryTransactions"] = [];
            for (let item of this.categoryTransactions)
                data["categoryTransactions"].push(item.toJSON());
        }
        super.toJSON(data);
        return data; 
    }
...
export interface ICategory extends IAuditableEntity {
    ...
    transactions?: Transaction[] | undefined;
    categoryTransactions?: ICategoryTransaction[] | undefined;
}

export class Fund extends AuditableEntity implements IFund {
    id?: string | undefined;
    name?: string | undefined;
    expenses?: number;
    income?: number;
    ...
    manager?: DomainUser | undefined;
    transactions?: Transaction[] | undefined;
    users?: DomainUser[] | undefined;
    ...
    constructor(data?: IFund) {
        super(data);
        if (data) {
            this.manager = data.manager && !(<any>data.manager).toJSON ? new DomainUser(data.manager) : <DomainUser>this.manager; 
            if (data.users) {
                this.users = [];
                for (let i = 0; i < data.users.length; i++) {
                    let item = data.users[i];
                    this.users[i] = item && !(<any>item).toJSON ? new DomainUser(item) : <DomainUser>item;
                }
            }
            if (data.domainEvents) {
                this.domainEvents = [];
                for (let i = 0; i < data.domainEvents.length; i++) {
                    let item = data.domainEvents[i];
                    this.domainEvents[i] = item && !(<any>item).toJSON ? new DomainEvent(item) : <DomainEvent>item;
                }
            }
        }
    }
    ...
    init(_data?: any) {
        ...
        if (_data) {
            ...
            this.manager = _data["manager"] ? DomainUser.fromJS(_data["manager"]) : <any>undefined;
            if (Array.isArray(_data["transactions"])) {
                this.transactions = [] as any;
                for (let item of _data["transactions"])
                    this.transactions!.push(Transaction.fromJS(item));
            ...
            if (Array.isArray(_data["users"])) {
                ...
                for (let item of _data["users"])
                    this.users!.push(DomainUser.fromJS(item));
            }
...
export interface IFund extends IAuditableEntity {
    id?: string | undefined;
    name?: string | undefined;
    expenses?: number;
    income?: number;
    balance?: number;
    managerId?: string | undefined;
    manager?: IDomainUser | undefined;
    transactions?: Transaction[] | undefined;
    users?: IDomainUser[] | undefined;
    memberships?: Membership[] | undefined;
    domainEvents?: IDomainEvent[] | undefined;
}

export class DomainUser implements IDomainUser {
    id?: string | undefined;
    funds?: Fund[] | undefined;
    managingFunds?: Fund[] | undefined;
    memberships?: Membership[] | undefined;

    constructor(data?: IDomainUser) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
        ...
        if (_data) {
            ...
            if (Array.isArray(_data["funds"])) {
                ...
                for (let item of _data["funds"])
                    this.funds!.push(Fund.fromJS(item));
            }
            if (Array.isArray(_data["managingFunds"])) {
                this.managingFunds = [] as any;
                for (let item of _data["managingFunds"])
                    this.managingFunds!.push(Fund.fromJS(item));
            }
            if (Array.isArray(_data["memberships"])) {
                this.memberships = [] as any;
                for (let item of _data["memberships"])
    ...
    static fromJS(data: any): DomainUser {
        data = typeof data === 'object' ? data : {};
        let result = new DomainUser();
        result.init(data);
        return result;
    }
    ...
    toJSON(data?: any) {
        ...
        if (Array.isArray(this.funds)) {
            ...
            for (let item of this.funds)
                data["funds"].push(item.toJSON());
        }
        if (Array.isArray(this.managingFunds)) {
            data["managingFunds"] = [];
            for (let item of this.managingFunds)
                data["managingFunds"].push(item.toJSON());
        }
        if (Array.isArray(this.memberships)) {
            data["memberships"] = [];
            for (let item of this.memberships)
...
export class Membership extends AuditableEntity implements IMembership {
    fundId?: string | undefined;
    fund?: Fund | undefined;
    ...
    constructor(data?: IMembership) {
        ...
        if (data) {
            this.fund = data.fund && !(<any>data.fund).toJSON ? new Fund(data.fund) : <Fund>this.fund; 
            this.domainUser = data.domainUser && !(<any>data.domainUser).toJSON ? new DomainUser(data.domainUser) : <DomainUser>this.domainUser; 
        }
    }
    ...
    init(_data?: any) {
        ...
        if (_data) {
            ...
            this.domainUser = _data["domainUser"] ? DomainUser.fromJS(_data["domainUser"]) : <any>undefined;
        }
    }
    ...
    toJSON(data?: any) {
        ...
        data["domainUser"] = this.domainUser ? this.domainUser.toJSON() : <any>undefined;
        super.toJSON(data);
        return data; 
    }
}

export interface IMembership extends IAuditableEntity {
    fundId?: string | undefined;
    fund?: IFund | undefined;
    userId?: string | undefined;
    domainUser?: IDomainUser | undefined;
}
...
export class CategoryTransaction implements ICategoryTransaction {
    categoryId?: string | undefined;
    category?: Category | undefined;
    transactionId?: string | undefined;
    transaction?: Transaction | undefined;

    constructor(data?: ICategoryTransaction) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
            ...
            this.transaction = data.transaction && !(<any>data.transaction).toJSON ? new Transaction(data.transaction) : <Transaction>this.transaction; 
        }
    }
    ...
    static fromJS(data: any): CategoryTransaction {
        data = typeof data === 'object' ? data : {};
        let result = new CategoryTransaction();
        result.init(data);
        return result;
    }
