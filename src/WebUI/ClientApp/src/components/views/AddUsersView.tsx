...
export function AddUsersView({backButtonClicked, users, addUserEvent}: IProps) {
    return (
        <Fragment>
            ...
            {users ? <UserTileList type="add" users={users} clicked={(_, data) => addUserEvent(data) }/> : "loading..."}
        </Fragment>
