...
export function CurrentUsersView({people, newUserClicked, removeUserEvent}: IProps) {
    return (
        <div>
            ...
            {people ? <UserTileList users={people} type="remove"  clicked={(_, data) => removeUserEvent(data)}/> : "loading..."}
        </div>
    )
}
